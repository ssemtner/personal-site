...
export const DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      start: "Sep 2020",
      end: "Jun 2023, Jan 2026 - Present",
      description:
        "Currently helping students develop control systems for a competitive high school robotics competition. Previously led software development as a student, ranking 16th globally out of 3,000+ teams. Developed autonomous navigation systems, swerve drive kinematics, and real-time motion control in C++. Team won Quality Award at World Championship and multiple engineering awards.",
    },
  ],
  education: [
    {
    ...
    },
    {
      school: "University of California San Diego",
      href: "https://cse.ucsd.edu",
      degree: "Masters's in Computer Science (Computer Engineering)",
      logoUrl: "/ucsd.png",
      start: "Jan 2026",
      end: "Jun 2027",
    },
